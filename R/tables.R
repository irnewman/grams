...
#'
#' @export
build_freq_tables <- function(words,
                              n                 = 1:3,
                              method            = c("type", "token"),
                              corpus,
                              word_frequency    = NULL,
...
#' the core computation underlying \code{\link{build_freq_tables}}.
#'
...
#'
#' @seealso \code{\link{build_freq_tables}}, \code{\link{build_ngram_cache}}
#'
#' @examples
#' \dontrun{
...
#'   \code{length_counts}.
#'
#' @seealso \code{\link{tally_ngram_frequencies}}, \code{\link{build_freq_tables}}
#'
#' @examples
#' \dontrun{
#' freq_table <- tally_ngram_frequencies(
